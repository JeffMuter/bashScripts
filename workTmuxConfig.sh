...
if ! tmux has-session -t work 2>/dev/null; then
    ...
    tmux send-keys -t work:0 'cd repos/javascript/eCommerce/cloudinary-styles-sync/src/watcher' C-m
    tmux send-keys -t work:0 'node watcher.js' C-m
    ...
    tmux send-keys -t work:1 'cd repos/javascript/eCommerce/cloudinary-styles-sync/src/cloudinary-sync-files/templates' C-m
fi
